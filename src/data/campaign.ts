    ...
    stages: [
      {
        ...
        enemy: {
          ...
          baseLk: 25,
          passiveKey: 'research',
          passiveDesc: 'Deep Research: Enemy buffs/debuffs last +1 round on correct trade.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 15,
          passiveKey: 'alpha',
          passiveDesc: 'Alpha Entry: Correct trades grant ×1.2 profit bonus.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 10,
          passiveKey: 'ironwall',
          passiveDesc: 'Iron Wall: DEF cap 70%. Gains +3% DEF per correct defend.',
      ...
      },
      {
        ...
        enemy: {
          ...
          passiveDesc: 'Blood Rush: Each hit raises ATK by +0.03 (stacks to ×1.4). Resets on wrong trade.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 30,
          passiveKey: 'fortune',
          passiveDesc: 'Fortune Weave: HOLD heals 10 HP. LCK ×1.5 for crits.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 10,
          passiveKey: 'ironwall',
          passiveDesc: 'Iron Wall: DEF cap 80%. Gains +8% DEF per correct defend.',
    ...
    stages: [
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 15,
          passiveKey: 'alpha',
          passiveDesc: 'Alpha Entry: Correct trades grant ×1.4 profit bonus.',
          difficultyMultiplier: 1.30,
        },
        coinId: 'eth',
        rewards: [
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 10,
          passiveKey: 'sendit',
          passiveDesc: 'Send It: EXTREME coins deal ×1.5 damage. Comeback at 15% HP.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 30,
          passiveKey: 'fortune',
          passiveDesc: 'Fortune Weave: HOLD heals 15 HP. LCK ×1.5 for crits.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 25,
          passiveKey: 'research',
          passiveDesc: 'Deep Research: Enemy buffs/debuffs last +2 rounds on correct trade.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 10,
          passiveKey: 'sendit',
          passiveDesc: 'Send It: EXTREME coins deal ×2.0 damage. Comeback at 25% HP.',
    ...
    stages: [
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 10,
          passiveKey: 'ironwall',
          passiveDesc: 'Iron Wall: DEF cap 75%. Gains +5% DEF per correct defend.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 20,
          passiveKey: 'bloodrush',
          passiveDesc: 'Blood Rush: Each hit raises ATK by +0.05 (stacks to ×1.6). Resets on wrong trade.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 30,
          passiveKey: 'fortune',
          passiveDesc: 'Fortune Weave: HOLD heals 20 HP. LCK ×2 for crits.',
      ...
      },
      {
        ...
        enemy: {
          ...
          baseLk: 10,
          passiveKey: 'sendit',
          passiveDesc: 'Send It: EXTREME coins deal ×2.5 damage. Comeback at 30% HP. +0.05 ATK every 3 rounds.',
